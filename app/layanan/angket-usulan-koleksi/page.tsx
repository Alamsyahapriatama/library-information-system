    ...
    <div className="min-h-screen bg-gray-100 pt-28 pb-12 flex justify-center items-start">
      ...
      <div className="max-w-6xl w-full bg-white rounded-xl shadow-lg p-8 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Usulan Judul Buku yang direkomendasikan */}
          <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
            <label htmlFor="bookTitleProposal" className="block text-lg font-medium text-gray-900 mb-2">
              Usulan Judul Buku yang direkomendasikan <span className="text-red-500">*</span>
            </label>
            <textarea
              id="bookTitleProposal"
              name="bookTitleProposal"
              value={bookTitleProposal}
              onChange={(e) => setBookTitleProposal(e.target.value)}
          ...
          {submissionStatus === 'success' && (
            <div className="flex items-center p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
              ...
              <div>
                <span className="font-medium">Berhasil!</span> Usulan pengadaan koleksi Anda telah terkirim. Terima kasih atas rekomendasinya!
              </div>
            </div>
          )}
