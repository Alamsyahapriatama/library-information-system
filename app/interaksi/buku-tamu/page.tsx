...
import React, { useState, useEffect } from "react"; // Hanya useState dan useEffect jika diperlukan untuk fitur lain
import Image from "next/image";
import Link from "next/link";
// Icon Lucide React tidak lagi relevan jika halaman ini hanya menampilkan konten statis sesuai gambar
...
export default function GuestBookAndNewsPage() {
  ...
  const popularArticles = [
    ...
    // HANYA 4 ARTIKEL DIATAS YANG AKAN TAMPIL SESUAI GAMBAR
    // Sisanya dihapus atau di-komentar agar sesuai gambar
    /*
        {
            imageSrc: "https://images.pexels.com/photos/11267866/pexels-photo-11267866.jpeg?auto=compress&cs=tinysrgb&w=800",
            title: "SRI REJEKI di Lingkungan SMAN 6 Berau",
            date: "05 Juni 2024",
            summary: "Sri Rejeki (Aglaonema) adalah tanaman hias populer dari suku talas-talasan (Araceae). Tanaman ini sangat mudah dirawat dan daunnya indah..."
        },
        {
            imageSrc: "https://images.pexels.com/photos/11181827/pexels-photo-11181827.jpeg?auto=compress&cs=tinysrgb&w=800",
            title: "TANAMAN ALPUKAT yang ada dilingkungan SMAN 6 Berau",
            date: "10 Juni 2024",
            summary: "Alpukat adalah buah yang berasal dari Amerika Tengah dan Meksiko. Di lingkungan sekolah kami, tanaman alpukat tumbuh subur dan berbuah lebat..."
        },
        {
            imageSrc: "https://images.pexels.com/photos/7901193/pexels-photo-7901193.jpeg?auto=compress&cs=tinysrgb&w=800",
            title: "POHON KELOR",
            date: "15 Juni 2024",
            summary: "Pohon kelor (Moringa oleifera) dikenal sebagai 'pohon ajaib' karena kandungan nutrisinya yang melimpah. Daunnya kaya akan vitamin, mineral, dan antioksidan..."
        },
        {
            imageSrc: "https://images.pexels.com/photos/1577908/pexels-photo-1577908.jpeg?auto=compress&cs=tinysrgb&w=800",
            title: "POHON BUNGA TANJUNG",
            date: "18 Juni 2024",
            summary: "Bunga Tanjung (Mimusops elengi) adalah pohon penghasil rempah-rempah dari Sri Lanka dan Burma..."
        },
        */
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-12">
      {/* Top Banner (gambar statis dengan overlay) */}
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            {/* Sudah ada di atas, ini duplikasi seperti di gambar */}
            <ul className="space-y-2 text-gray-700">
              <li>
                <Link href="#" className="hover:text-blue-600">
                  Lihat Semua Agenda
